...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$create_temp', '$lambda', '$getText', '$write', '$+', '$parse_single', '$<<', '$puts', '$sort', '$compact', '$call', '$new', '$getActiveEditor', '$workspace', '$Native', '$getCursor', '$getBufferRow', '$getBuffer', '$getBufferColumn', '$getTextInRange', '$-', '$completions', '$to_n', '$match', '$first', '$captures', '$file', '$raise']);
  ;
  return (function($base) {
...
if (suggestions == null) suggestions = nil;
      ...
      return (def.$create_temp = function(cb) {
        var $a, $b, TMP_6, self = this, tmp = nil;

        tmp = self.$Native(require("tmp"));
        return tmp.$file({ postfix: ".racertmp" }, ($a = ($b = self).$lambda, $a._p = (TMP_6 = function(err, path, fd){var self = TMP_6._s || this, $a, $b;
