...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$native_accessor', '$alias_native', '$[]', '$to_n', '$map', '$respond_to?', '$to_path']);
  ;
  ;
  ;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      self.$native_accessor("clipboard", "config", "context_menu", "deserializers", "keymap", "menu", "packages", "project", "syntax", "themes", "workspace", "github_auth_token");
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$create_temp', '$lambda', '$getText', '$write', '$+', '$parse_single', '$<<', '$puts', '$sort', '$compact', '$call', '$new', '$getActiveEditor', '$workspace', '$Native', '$getCursor', '$getBufferRow', '$getBuffer', '$getBufferColumn', '$getTextInRange', '$-', '$=~', '$completions', '$to_n', '$match', '$first', '$captures', '$map', '$split', '$file', '$raise']);
  ;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.atom = def.editor = nil;
      Suggestion = require("autocomplete-plus").Suggestion;

      self.$attr_accessor("atom", "editor", "text", "tempfile", "file", "filepath", "candidates");
      ...
      def.$completions = function(editor, row, col, cb) {
        ...
        self.editor = editor;
        self.candidates = [];
        return self.$create_temp(($a = ($b = self).$lambda, $a._p = (TMP_1 = function(tempfile){var self = TMP_1._s || this, $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, command = nil, args = nil, stdout = nil, stderr = nil, myexit = nil, buffer = nil;
...
if (output == null) output = nil;
          ...
          stderr = ($a = ($c = self).$lambda, $a._p = (TMP_3 = function(arg){var self = TMP_3._s || this;
if (arg == null) arg = nil;
          return self.$puts(arg)}, TMP_3._s = self, TMP_3), $a).call($c);
          myexit = ($a = ($d = self).$lambda, $a._p = (TMP_4 = function(code){var self = TMP_4._s || this;
            if (self.candidates == null) self.candidates = nil;
if (code == null) code = nil;
          self.candidates = self.candidates.$compact().$sort();
            return cb.$call(self.candidates);}, TMP_4._s = self, TMP_4), $a).call($d);
          return buffer = (($a = ((($e = $scope.Atom) == null ? $opal.cm('Atom') : $e))._scope).BufProcess == null ? $a.cm('BufProcess') : $a.BufProcess).$new(command, args, stdout, myexit);}, TMP_1._s = self, TMP_1), $a).call($b));
      };

      def.$check_completion = function(cb) {
        var $a, $b, TMP_5, self = this, cursor = nil, row = nil, tbuffer = nil, col = nil, last_char = nil;
        ...
        if ((($a = last_char['$=~'](/::/)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.$completions(self.editor, row, col, ($a = ($b = self).$lambda, $a._p = (TMP_5 = function(suggestions){var self = TMP_5._s || this;
if (suggestions == null) suggestions = nil;
          return cb.$call(null, suggestions.$to_n())}, TMP_5._s = self, TMP_5), $a).call($b))
          } else {
          return cb.$call(null, [])
        };
      };
      ...
      def.$parse_single = function(line) {
        ...
        if ((($a = matches = line.$match(/^MATCH (\w*)\,/)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$parse_completions = function(output) {
        var $a, $b, TMP_6, self = this;

        return ($a = ($b = output.$split("\n")).$map, $a._p = (TMP_6 = function(line){var self = TMP_6._s || this, $a, matches = nil;
if (line == null) line = nil;
        if ((($a = matches = line.$match(/^MATCH (\w*)\,/)) !== nil && (!$a._isBoolean || $a == true))) {
            return matches.$captures().$first()
            } else {
            return nil
          }}, TMP_6._s = self, TMP_6), $a).call($b).$compact();
      };

      def.$arrange_suggestions = function(candidates) {
        var $a, $b, TMP_7, self = this;

        return ($a = ($b = candidates).$map, $a._p = (TMP_7 = function(candidate){var self = TMP_7._s || this;
if (candidate == null) candidate = nil;
        return self.$Native(new Suggestion(this, { word: candidate, label: candidate }))}, TMP_7._s = self, TMP_7), $a).call($b);
      };

      return (def.$create_temp = function(cb) {
        var $a, $b, TMP_8, self = this, tmp = nil;

        tmp = self.$Native(require("tmp"));
        return tmp.$file({ postfix: ".racertmp" }, ($a = ($b = self).$lambda, $a._p = (TMP_8 = function(err, path, fd){var self = TMP_8._s || this, $a, $b;
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_accessor', '$new', '$Native', '$workspace_view', '$eachEditorView', '$lambda', '$editor', '$on', '$=~', '$name', '$getGrammar', '$!', '$mini', '$getActiveView', '$registerProviderForEditorView', '$to_n', '$<<', '$init']);
  ;
  ;
  ;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$register_providers = function() {
        var $a, $b, TMP_1, self = this, workspace_view = nil;

        workspace_view = self.$Native(self.atom.$workspace_view());
        return workspace_view.$eachEditorView(($a = ($b = self).$lambda, $a._p = (TMP_1 = function(editorView){var self = TMP_1._s || this, $a, $b, TMP_2, editor = nil;
if (editorView == null) editorView = nil;
        editorView = self.$Native(editorView);
          editor = editorView.$editor();
          return editor.$on("grammar-changed", ($a = ($b = self).$lambda, $a._p = (TMP_2 = function(){var self = TMP_2._s || this, $a, $b, view = nil, provider = nil;
            if (self.autocomplete == null) self.autocomplete = nil;

          if ((($a = ($b = editor.$getGrammar().$name()['$=~'](/Rust/), $b !== false && $b !== nil ?editorView.$mini()['$!']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
              view = workspace_view.$getActiveView();
              RacerProvider = require("../racer-provider");
              provider = new RacerProvider(editorView);
              return self.autocomplete.$registerProviderForEditorView(provider, editorView.$to_n());
              } else {
              return nil
